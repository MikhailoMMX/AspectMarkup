...
namespace LWLex
{
    ...
    public class Program : LEX_TreeNode
    {
    ...
    public class Regex1 : LEX_TreeNode
    {
        public Regex1(List<string> Value, LexLocation Location)
        {
            this.Value = Value;
            this.Location = Location;
        }
        public Regex1(string Value, LexLocation Location)
        {
            this.Value = new List<string>();
            this.Value.Add(Value);
            this.Location = Location;
    ...
    public class Regex2 : LEX_TreeNode
    {
        public Regex2(List<string> Value, LexLocation Location)
        {
            this.Value = Value;
            this.Location = Location;
        }
        public Regex2(string Value, LexLocation Location)
        {
            this.Value = new List<string>();
            this.Value.Add(Value);
            this.Location = Location;
    ...
    public class IdList : LEX_TreeNode
    {
        public IdList(List<string> Value, LexLocation Location)
        {
            this.Value = Value;
            this.Location = Location;
        }
        public IdList(string Value, LexLocation Location)
        {
            this.Value = new List<string>();
            this.Value.Add(Value);
            this.Location = Location;
    ...
    public class Section1 : LEX_TreeNode
    {
    ...
    public class RegexDecl : LEX_TreeNode
    {
        public RegexDecl(List<string> Value, LexLocation Location)
        {
            this.Value = Value;
            this.Location = Location;
        }
        public RegexDecl(string Value, LexLocation Location)
        {
            this.Value = new List<string>();
            this.Value.Add(Value);
            this.Location = Location;
    ...
    public class StateDecl : LEX_TreeNode
    {
        public StateDecl(List<string> Value, LexLocation Location)
        {
            this.Value = Value;
            this.Location = Location;
        }
        public StateDecl(string Value, LexLocation Location)
        {
            this.Value = new List<string>();
            this.Value.Add(Value);
            this.Location = Location;
    ...
    public class Section2 : LEX_TreeNode
    {
    ...
    public class RuleOrGroup : LEX_TreeNode
    {
        public RuleOrGroup(List<string> Value, LexLocation Location)
        {
            this.Value = Value;
            this.Location = Location;
        }
        public RuleOrGroup(string Value, LexLocation Location)
        {
            this.Value = new List<string>();
            this.Value.Add(Value);
            this.Location = Location;
    ...
    public class LexRule : LEX_TreeNode
    {
        public LexRule(List<string> Value, LexLocation Location)
        {
            this.Value = Value;
            this.Location = Location;
        }
        public LexRule(string Value, LexLocation Location)
        {
            this.Value = new List<string>();
            this.Value.Add(Value);
            this.Location = Location;
    ...
    public class Group : LEX_TreeNode
    {
        public Group(List<string> Value, LexLocation Location)
        {
            this.Value = Value;
            this.Location = Location;
        }
        public Group(string Value, LexLocation Location)
        {
            this.Value = new List<string>();
            this.Value.Add(Value);
            this.Location = Location;
    ...
    public interface LEX_Visitor
    {
       ...
       void Visit(Regex1 _Regex1);
       void Visit(Regex2 _Regex2);
       void Visit(IdList _IdList);
       void Visit(Section1 _Section1);
       void Visit(RegexDecl _RegexDecl);
       void Visit(StateDecl _StateDecl);
       void Visit(Section2 _Section2);
       void Visit(RuleOrGroup _RuleOrGroup);
       void Visit(LexRule _LexRule);
       void Visit(Group _Group);
