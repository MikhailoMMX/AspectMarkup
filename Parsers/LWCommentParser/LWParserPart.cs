...
namespace LWParser
{
    public class ANY_TreeNode : SourceEntity
    {
        public ANY_TreeNode(List<string> Value, LexLocation Location)
        {
            this.Value = Value;
            this.Location = Location;
        }
        public ANY_TreeNode(string Value, LexLocation Location)
        {
        ...
        public virtual void Accept(ANY_Visitor v)
        {
            v.Visit(this);
        }
    }
    public class CommentStart : ANY_TreeNode
    {
        public CommentStart(List<string> Value, LexLocation Location)
        {
            this.Value = Value;
            this.Location = Location;
        }
        public CommentStart(string Value, LexLocation Location)
        {
            this.Value = new List<string>();
            this.Value.Add(Value);
            this.Location = Location;
        ...
        public override void Accept(ANY_Visitor v)
        {
            v.Visit(this);
        }
    }
    public class CommentEnd : ANY_TreeNode
    {
        public CommentEnd(List<string> Value, LexLocation Location)
        {
            this.Value = Value;
            this.Location = Location;
        }
        public CommentEnd(string Value, LexLocation Location)
        {
            this.Value = new List<string>();
            this.Value.Add(Value);
            this.Location = Location;
    ...
    public class Token : ANY_TreeNode
    {
    ...
    public interface ANY_Visitor
    {
       void Visit(ANY_TreeNode _ANY_TreeNode);
       void Visit(CommentStart _CommentStart);
       void Visit(CommentEnd _CommentEnd);
  ...
  public sealed partial class Scanner : ScanBase
    ...
    {
        public string[] LanguageID { get { return new string[] { "*" }; } }
    }
    public partial class LightweightParser : LightweightParserBase
    {
        public override string[] LanguageID { get { return new string[] { "*" }; } }
    }
